...
abstract class handleLists extends listObjects {
	...
	public function create($nameList) { 
		...
		if (!$this->isNameExistInArray($nameList)) { // There no list with this name 
	...
	public function modify($nameList, $valuesArr) {
